import {AddNewProcess, ProcessConfigContainer, ManageScaleContainer, ScaleBtn, ScaleCombineBtn} from "./styles"
  ...
  return <ProcessConfigContainer>
    ...
    <ManageScaleContainer>
      ...
      <ScaleCombineBtn>
        ...
        <ScaleBtn onClick={handleRemoveScaleBefore}> <img src={less} alt="less"/><img src={minus} alt="minus"/>  </ScaleBtn>
      </ScaleCombineBtn>
      <ScaleCombineBtn>
        <ScaleBtn onClick={handleAddScaleAfter}> <img src={plus} alt="plus"/> <img src={greater} alt="greater"/> </ScaleBtn>
        <ScaleBtn onClick={handleRemoveScaleAfter}> <img src={minus} alt="minus"/> <img src={greater} alt="greater"/> </ScaleBtn>
      </ScaleCombineBtn>
